...
class Xception(nn.Module):
    ...
    def __init__(self, channels, block, num_class=14):
        super().__init__()
        self.entry_flow = EntryFlow(channels)
...
def xception(channels, num_classes):
    return Xception(channels, MiddleFLowBlock, num_class = num_classes)
